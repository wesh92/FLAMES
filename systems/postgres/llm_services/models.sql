...
(
    id                          text                                                                                        not null
        constraint unique_id
            unique,
    object                      text          default 'model'::text not null,
    ...
    constraint models_pk
        primary key (id, object, created, owned_by)
);
...
comment on column public.models.object is 'model type';

comment on column public.models.created is 'When the model or other type was created';
